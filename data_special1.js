...
[Retence uremických toxinů] [Porucha elektrolytů] [Deficit hormonů]
 ...
 └─► Perikarditida               └─► Acidóza (retence H+)   └─► Osteodystrofie
    ...
    detailContent: `
      <div class="medical-detail">
        <section>
          ...
          <ul>
            <li><strong>Typ I (hypoxemické):</strong> Selhání oxygenace krve (paO2 < 8 kPa při normálním nebo nízkém paCO2). Příčinou je V/Q nepoměr (zkrat) nebo porucha difúze.</li>
            <li><strong>Typ II (hyperkapnické):</strong> Selhání ventilace (paCO2 > 6.7 kPa). Příčinou je alveolární hypoventilace (selhání respirační pumpy, únava svalů, deprese dechového centra).</li>
          </ul>
        </section>
        <section>
          <h3>2. ARDS (Syndrom akutní respirační tísně)</h3>
          <p>ARDS je závažná forma nekardiogenního plicního edému charakterizovaná **difúzním alveolárním poškozením (DAD)**. Vzniká jako reakce na těžký zánět (sepse, těžké trauma, aspirace žaludečního obsahu).</p>
          ...
          <ol>
            ...
            <li><strong>Proliferativní a fibrotická fáze:</strong> Pokud pacient přežije, dochází k nekontrolované proliferaci fibroblastů a ukládání kolagenu.</li>
          </ol>
        </section>
      </div>
    `,
    quiz: [
      {
        ...
        options: [
          ...
          "Kompletní uzávěr plicní tepny"
        ],
        correct: 2,
        explanations: [
          "Nesprávně. Poddajnost plic u ARDS prudce klesá, plíce jsou tuhé.",
          "Nesprávně. Popisuje kardiogenní plicní edém. U ARDS je edém nekardiogenní a tekutina je bohatá na bílkoviny.",
          ...
          "Nesprávně. ARDS je syndrom difúzního parenchymového poškození."
        ]
      }
    ]
  },
  ...
  "spec-1-7": {
    richContent: {
      definition: "Regulace endokrinních os je založena na principu negativní zpětné vazby, kdy koncentrace periferního hormonu tlumí sekreci stimulujícího hormonu v hypotalamu a hypofýze. Porucha této vazby vede k endokrinopatiím.",
      etiology: [
        "Primární poruchy (periferní žláza): autoimunitní destrukce (Hashimotova tyreoiditida, Addisonova choroba) nebo adenomy (Gravesova choroba, Connův syndrom).",
        "Sekundární poruchy (hypofýza): adenomy hypofýzy (prolaktinom, ACTH tumor), panhypopituitarismus, Sheehanův syndrom.",
        "Terciární poruchy (hypotalamus): tumory, kraniotrauma, poruchy sekrece statinů a liberinů.",
        "Iatrogenní vlivy: exogenní podávání hormonů (glukokortikoidy) vedoucí k supresi celé osy a atrofii žlázy."
      ],
      pathogenesis: [
        "Při primární destrukci periferní žlázy klesá hladina periferních hormonů, což odstraňuje negativní vazbu a vede k extrémnímu zvýšení hypofyzárních a hypotalamických hormonů.",
        "Při autonomní sekreci tumorem periferní žlázy vysoká hladina hormonu utlumí hypofýzu (např. nízké TSH při vysokém fT4).",
        "Při exogenním podávání hormonů (např. prednisonu) dochází k supresi hypotalamického CRH a hypofyzárního ACTH, což vyústí v atrofii kůry nadledvin z nedostatku stimulace."
      ],
      clinicalManifestation: [
        "Symptomy hyperfunkce (např. tyrotoxikóza při Gravesově chorobě: hubnutí, tachykardie, neklid).",
        "Symptomy hypofunkce (např. myxedém u hypotyreózy: únava, chladová intolerance, bradykardie).",
        "U dětí gigantismus/trpasličí vzrůst při poruše osy růstového hormonu."
      ],
      diagnostics: [
        "Měření bazálních hladin hormonů v séru (periferní hormon + odpovídající tropní hormon).",
        "Dynamické stimulační testy (např. synacthenový pro nadledviny) k potvrzení hypofunkce.",
        "Dynamické supresní testy (dexametazonový supresní test) k potvrzení autonomní hyperfunkce."
      ]
    },
    quiz: [
      {
        question: "Jaký hormonální profil (TSH a fT4) v séru potvrdí diagnózu primární hypotyreózy (např. Hashimotovy tyreoiditidy)?",
        options: [
          "Nízké TSH a vysoké fT4",
          "Vysoké TSH a nízké fT4",
          "Nízké TSH a nízké fT4",
          "Vysoké TSH a vysoké fT4"
        ],
        correct: 1,
        explanations: [
          "Nesprávně. Toto je obraz primární hypertyreózy.",
          "Správně! U primární hypotyreózy je štítná žláza poškozena a netvoří fT4 (nízká hladina). Nedostatek fT4 odstraňuje negativní zpětnou vazbu na hypofýzu, která reaguje maximálním zvýšením sekrece TSH (vysoká hladina) ve snaze žlázu stimulovat.",
          "Nesprávně. Nízké TSH i fT4 svědčí pro sekundární (centrální) hypotyreózu (porucha hypofýzy).",
          "Nesprávně. Vysoké TSH i fT4 svědčí pro syndrom rezistence na tyroidální hormony nebo TSH produkující adenom."
        ]
      }
    ]
  },
